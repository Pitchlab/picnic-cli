...
This is a thin CLI wrapper around [`picnic-api`](https://www.npmjs.com/package/picnic-api), which does all of the heavy lifting — API communication, authentication, session management, etc. This project just provides the terminal interface on top.
